...
export default function Login() {
  ...
  const [user, setUser] = useState('human_director');
  const [pw, setPw] = useState('human_director_pass');
        ...
        <label className="block">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              setUser(v);
              if (v === 'human_director') setPw('human_director_pass');
            }}
            required
            placeholder="human_director"
            className="w-full px-3 py-2 bg-gray-100 rounded-lg text-sm outline-none focus:bg-white focus:ring-2 focus:ring-blue-200"
          />
        </label>
        <label className="block">
